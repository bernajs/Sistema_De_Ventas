          ...
          <div id="page-inner">
            ...
            <div class="row container">
              <div class="col-md-3 col-sm-6 col-xs-6">
                        ...
                        <!--<div class="col-md-12">
                          ...
                          <div class="table-responsive">
                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                              ...
                              <tbody>
                                <!--<?php //echo "holaaa" ?>-->
                                <?php $datos=$this->getDatos();foreach ($datos as $key => $pedido):?>                                
                                
                                
                                <tr>
                                  <!--<?php //echo "holaaaa" ?>-->
                                  <td><?php echo $pedido->idPedido;?></td>
                                  <td><?php echo $pedido->formaPago;?></td>
                                  ...
                                  <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button value="<?php echo $pedido->idPedido;?>" data-toggle="modal" class="btn btn-primary btn-xs prueba" data-title="Edit"  data-target="#edit"><span class="glyphicon glyphicon-pencil"></span></button></a></p></td>
                                  <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button value="<?php echo $pedido->idPedido;?>" class="btn btn-danger btn-xs prueba1"><span class="glyphicon glyphicon-trash"></span></button></p></td>
                                </tr>
                                <?php endforeach;?>
                ...
                $("#modal-edit").load("<?php echo URL_BASE;?>/index.php/Pedido/eliminar_pedido",{identificadorr:$(this).val()});
                });
                
                $(".prueba").on("click", function(){
                $("#modal-edit").load("<?php echo URL_BASE;?>/index.php/Pedido/modificar_pedido", {identificador:$(this).val()});
                });
                </script>
