...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="panel panel-default">
            ...
            <?php $p = $this->getDatos(); $d=$this->getDatos1(); $var=$this->getDatos2(); ?>
            <div class="panel-body">
                <form role="form" class="form" id="form1" method="POST" action="<?php echo URL_BASE;?>/index.php/Proveedor/actualizar_proveedor">
                    <div class="form-group input-group <?php if (isset($this->errores['rfc'])) echo 'has-error' ; ?>">
                        <!--<span class="input-group-addon"><i class="fa fa-genderless"></i></span>-->
                        <input class="form-control" name="rfc" id="rfc" placeholder="RFC" type="hidden" value="<?php echo $var['identificador'];?>">
