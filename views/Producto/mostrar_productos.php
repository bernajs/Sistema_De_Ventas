      ...
      <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button value="<?php echo $producto->codigo;?>" data-toggle="modal" class="btn btn-primary btn-xs prueba" data-title="Edit"  data-target="#edit"><span class="glyphicon glyphicon-pencil"></span></button></a></p></td>
                                  <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button value="<?php echo $producto->codigo;?>" class="btn btn-danger btn-xs prueba1"><span class="glyphicon glyphicon-trash"></span></button></p></td>
                                </tr>
                                <?php endforeach;?>
        ...
        <script type="text/javascript">
          $(".prueba1").on("click",function(){
            $("#modal-edit").load("<?php echo URL_BASE;?>/index.php/Producto/eliminar_producto",{identificadorr:$(this).val()});
          });
        
          $(".prueba").on("click", function(){        
            $("#modal-edit").load("<?php echo URL_BASE;?>/index.php/Producto/modificar_producto", {identificador:$(this).val()});                
          });
        </script>
